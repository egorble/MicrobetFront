    ...
    const pools = [
        {
            ...
            style: "bg-gradient-to-br from-red-600 to-red-700 text-white shadow-lg ring-1 ring-red-500 transform hover:-translate-y-2",
        ...
        },
        {
            ...
            style: "bg-gray-900 text-white shadow-md ring-1 ring-gray-800 transform hover:-translate-y-1",
        ...
        },
        {
            ...
            style: "bg-white text-gray-900 shadow-sm border border-gray-200",
        ...
        },
        {
            ...
            style: "bg-gray-50 text-gray-900 border border-gray-100",
            textStyle: "text-gray-500",
            valueStyle: "text-gray-900",
            labelStyle: "text-gray-400"
        }
    ...
    return (
        <div className="py-8">
            <div className="text-center mb-10">
                <h2 className="text-3xl font-bold text-gray-900 mb-3">Prize Distribution</h2>
                    ...
                    >
                        <div>
                            <div className="flex justify-between items-start mb-4">
                                ...
                                <span className={`text-xs font-bold px-2 py-1 rounded-full uppercase tracking-wide ${pool.id === 4 ? 'bg-white/20 text-white' : pool.id === 3 ? 'bg-white/10 text-white' : 'bg-gray-100 text-gray-600'}`}>
                                    {pool.description}
                                </span>
                            </div>
