  ...
  return (
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200">
      ...
      {isChartVisible && (
        <div className="p-6">
          <div className="mb-4">
            <h3 className="text-lg font-semibold text-gray-800">{selectedToken}/USD Chart</h3>
            <p className="text-sm text-gray-600">Real-time {selectedToken} price chart from Binance (1-minute intervals, updates every second)</p>
          </div>
          <div 
